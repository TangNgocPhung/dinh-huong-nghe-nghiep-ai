...
(function () {
  ...
  const revealTargets = document.querySelectorAll(".card, .career-card, .about-panel, .pillar, .quiz-question, .overview-copy, .overview-tool, .overview-note, .theory-copy, .riasec-type, .mi-type, .external-assessment, section > h2");
